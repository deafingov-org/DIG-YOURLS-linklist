...
About:
Public link list page for YOURLS. Called by index.php in the YOURLS root directory.
Bootstraps the YOURLS environment and displays the public links list.

Features:
- Shows only active/visible links (controlled via Link Status Manager plugin)
- Displays full short URL with clipboard copy button
- Pagination with configurable per-page count (10/25/50/All)
- Logo, heading, and browser tab title configurable via plugin Page Settings
...
// Bootstrap YOURLS if not already loaded
...
<head>
    ...
    <style>
        ...
        .per-page-form select { padding: 2px 6px; font-size: 0.9rem; }
